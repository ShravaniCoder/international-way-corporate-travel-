...
export default function CorporateSolutions() {
  return <>
    <PageHero eyebrow="Corporate Solutions" title="Travel solutions aligned to business needs." text="Structured support for employee travel, executive movements, group requirements and corporate hospitality." image={IMG.business}/>
