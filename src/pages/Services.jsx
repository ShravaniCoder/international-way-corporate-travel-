...
export default function Services() {
  ...
  title="Business travel, from first detail to final arrival."
  text="A coordinated portfolio of travel and hospitality services for employees, executives, groups and business guests."
  image={IMG.serviceh}
